...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of HoloCollectionView.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/gonghonglou/HoloCollectionView'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'gonghonglou' => 'gonghonglou@icloud.com' }
  s.source           = { :git => 'https://github.com/gonghonglou/HoloCollectionView.git', :tag => s.version.to_s }
